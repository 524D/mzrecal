...
go run mzrecal.go gsl_wrapper.go -scoreFilter="MS:1002257(0.0:1e0)" "/home/robm/data/msrecal_ribosomes/human_ribosome_60S_bottomup_peak.mzML"
go run mzrecal.go gsl_wrapper.go -recal "/home/robm/data/msrecal_ribosomes/human_ribosome_60S_bottomup_peak.mzML"
