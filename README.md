...
USAGE EXAMPLES:
  ...
  mzrecal -recal BSA.mzML
     ...
     BSA-recal.mzML
robm@his:~/go/src/mzrecal$ ls -alh ppmerr.svg 
-rw-r--r-- 1 robm robm 38K Nov 30 12:54 ppmerr.svg
robm@his:~/go/src/mzrecal$ git add ppmerr.svg 
robm@his:~/go/src/mzrecal$ git commit 
[master a5dffdf] Added example of recalibration result for documentation purposes.
 1 file changed, 318 insertions(+)
 create mode 100644 ppmerr.svg
robm@his:~/go/src/mzrecal$ ~/tools/mzrecal --help
Usage of mzrecal:
